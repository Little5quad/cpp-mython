...
#undef UNVALUED_OUTPUT
    ...
    void Lexer::Parse(std::string& str) {
        size_t i = 0;
        ...
        else if (str[0] == '+' || str[0] == '-' || str[0] == '*' || str[0] == '/' || str[0] == '<' || str[0] == '>' || str[0] == '!' || str[0] == '=' || str[0] == '<' || str[0] == '>') {
            ParseOperation(str);
        }
        else if (str[0] == '_' || (str[0] >= 'a' && str[0] <= 'z') || (str[0] >= 'A' && str[0] <= 'Z') || (str.size() > 1 && (str.substr(0, 2) == "==" || str.substr(0, 2) == "!=" || str.substr(0, 2) == "<=" || str.substr(0, 2) == ">="))) {
            ParseId(str);
        }
    ...
    void Lexer::ParseNumber(std::string& str) {
        std::string value;
        size_t i = 0;
        ...
        tokens_.push_back(token_type::Number{ std::stoi(value) });
        str.erase(0, i);
    }
    ...
    void Lexer::ParseId(std::string& str) {
        string value;
        size_t i = 0;
    ...
    void Lexer::ParseOperation(std::string& str) {
        if (str[0] == '!' && str[1] == '=') {
            tokens_.push_back(token_type::NotEq{});
            str.erase(0, 2);
        }
